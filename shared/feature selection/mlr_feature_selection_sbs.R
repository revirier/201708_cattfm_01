...
ctrl = makeFeatSelControlSequential(same.resampling.instance = TRUE,
                                    impute.val = NULL, method='sbs', maxit = 10, max.features = NA_integer_
...
#feature selection
sfeats_sbs = selectFeatures(learner = lrn, task = cltask_1, resampling = rdesc, control = ctrl,
                        show.info = TRUE)


save(sfeats_sbs,file = "~/shared/feats_sbs")
