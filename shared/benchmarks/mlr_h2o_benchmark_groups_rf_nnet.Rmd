...
# LOAD DATASET
```{r}
load(file = "~/Master_ICM/TFM/r_Projects/2_fase/ds_icu_2m")
```
...
ltasks=list(cltask1,cltask2,cltask3,cltask4,cltask5,cltask6,cltask7,cltask8,cltask9,cltask10)
```
...
```{r}
save(file="~/Master_ICM/TFM/r_Projects/memoria/mlr_h2o_benchmark_groups/bmr",bmr)
```
