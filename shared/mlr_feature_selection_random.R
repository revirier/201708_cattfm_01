...
#feature selections sbs
# masure auc
# ctrl

ctrl = makeFeatSelControlRandom(same.resampling.instance = TRUE, maxit = 100L,
...
#feature selection
sfeats_rdm = selectFeatures(learner = lrn, task = cltask_1, resampling = rdesc, control = ctrl,
                        show.info = TRUE)


save(sfeats_rdm,file = "~/shared/feats_rdm")
